...
/* : !+ ( x addr1 -- addr2 ) */
static void ficlPrimitiveStorePlus(ficlVm *vm)
{
    ficlCell *pCell;
    ficlInteger x;

    FICL_STACK_CHECK(vm->dataStack,2,1);
    pCell = ficlStackPopPointer(vm->dataStack);
    pCell->i = ficlStackPopInteger(vm->dataStack);
    ficlStackPushPointer(vm->dataStack, pCell + 1);
}

/* : c!+ ( c c-addr1 -- c-addr2 ) */
static void ficlPrimitiveCStorePlus(ficlVm *vm)
{
    ficlUnsigned8 *pChar;

    FICL_STACK_CHECK(vm->dataStack,2,1);
    pChar = ficlStackPopPointer(vm->dataStack);
    *pChar = ficlStackPopUnsigned(vm->dataStack);
    ficlStackPushPointer(vm->dataStack, pChar + 1);
}

/* : @+ ( addr1 -- addr2 x ) */
static void ficlPrimitiveFetchPlus(ficlVm *vm)
{
    ficlCell *pCell;
    ...
    pCell = ficlStackPopPointer(vm->dataStack);
    ficlStackPushPointer(vm->dataStack, pCell + 1);
    ficlStackPushInteger(vm->dataStack, pCell->i);
}

/* : c@+ ( c-addr1 -- c-addr2 c ) */
static void ficlPrimitiveCFetchPlus(ficlVm *vm)
{
    ficlUnsigned8 *pChar;
    ...
    pChar = ficlStackPopPointer(vm->dataStack);
    ficlStackPushPointer(vm->dataStack, pChar + 1);
    ficlStackPushUnsigned(vm->dataStack, *pChar);
}

/* : c+! ( c c-addr1 -- ) */
static void ficlPrimitiveCPlusStore(ficlVm *vm)
{
    ficlUnsigned8 *pChar;
...
/* : +!+ ( x addr1 -- addr2 ) */
static void ficlPrimitivePlusStorePlus(ficlVm *vm)
{
    ficlCell *pCell;
    ficlInteger x;
...
/* : c+!+ ( c c-addr1 -- c-addr2 ) */
static void ficlPrimitiveCPlusStorePlus(ficlVm *vm)
{
    ficlUnsigned8 *pChar;
...
/* : >a ( x -- ) */
static void ficlPrimitiveToA(ficlVm *vm)
{
    FICL_STACK_CHECK(vm->dataStack, 1, 0);

    vm->areg.u = ficlStackPopUnsigned(vm->dataStack);
}

/* : a> ( x -- ) */
static void ficlPrimitiveAFrom(ficlVm *vm)
{
    FICL_STACK_CHECK(vm->dataStack, 0, 1);

    ficlStackPushUnsigned(vm->dataStack, vm->areg.u);
}

/* : a@ ( -- x ) */
static void ficlPrimitiveAFetch(ficlVm *vm)
{
    ficlUnsigned *ptr;
    ...
    ptr = vm->areg.p;
    ficlStackPushUnsigned(vm->dataStack, *ptr);
}

/* : a! ( x -- ) */
static void ficlPrimitiveAStore(ficlVm *vm)
{
    ficlUnsigned *ptr;
    ...
    ptr = vm->areg.p;
    *ptr = ficlStackPopUnsigned(vm->dataStack);

}

/* : a@+ ( -- x ) */
static void ficlPrimitiveAFetchPlus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : a@- ( -- x ) */
static void ficlPrimitiveAFetchMinus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : a!+ ( x -- ) */
static void ficlPrimitiveAStorePlus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : >b ( x -- ) */
static void ficlPrimitiveToB(ficlVm *vm)
{
    FICL_STACK_CHECK(vm->dataStack, 1, 0);

    vm->breg.u = ficlStackPopUnsigned(vm->dataStack);
}

/* : b> ( x -- ) */
static void ficlPrimitiveBFrom(ficlVm *vm)
{
    FICL_STACK_CHECK(vm->dataStack, 0, 1);

    ficlStackPushUnsigned(vm->dataStack, vm->breg.u);
}

/* : b@ ( -- x ) */
static void ficlPrimitiveBFetch(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : b! ( x -- ) */
static void ficlPrimitiveBStore(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : b@+ ( -- x ) */
static void ficlPrimitiveBFetchPlus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : b@- ( -- x ) */
static void ficlPrimitiveBFetchMinus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
/* : b!+ ( x -- ) */
static void ficlPrimitiveBStorePlus(ficlVm *vm)
{
    ficlUnsigned *ptr;
...
void ficlSystemCompileExtras(ficlSystem *system)
{
    ...
    addPrimitive(dictionary, "!+",      ficlPrimitiveStorePlus);
    addPrimitive(dictionary, "c!+",     ficlPrimitiveCStorePlus);

    addPrimitive(dictionary, "@+",      ficlPrimitiveFetchPlus);
    addPrimitive(dictionary, "c@+",     ficlPrimitiveCFetchPlus);

    addPrimitive(dictionary, "c+!",     ficlPrimitiveCPlusStore);

    addPrimitive(dictionary, "+!+",     ficlPrimitivePlusStorePlus);
    addPrimitive(dictionary, "c+!+",    ficlPrimitiveCPlusStorePlus);

    /* Pelc, EuroForth 2008 */
    addPrimitive(dictionary, ">a",  ficlPrimitiveToA);
    addPrimitive(dictionary, "a>",  ficlPrimitiveAFrom);
    addPrimitive(dictionary, "a@",  ficlPrimitiveAFetch);
    addPrimitive(dictionary, "a!",  ficlPrimitiveAStore);
    addPrimitive(dictionary, "a@+", ficlPrimitiveAFetchPlus);
    addPrimitive(dictionary, "a@-", ficlPrimitiveAFetchMinus);
    addPrimitive(dictionary, "a!+", ficlPrimitiveAStorePlus);
    addPrimitive(dictionary, ">b",  ficlPrimitiveToB);
    addPrimitive(dictionary, "b>",  ficlPrimitiveBFrom);
    addPrimitive(dictionary, "b@",  ficlPrimitiveBFetch);
    addPrimitive(dictionary, "b!",  ficlPrimitiveBStore);
    addPrimitive(dictionary, "b@+", ficlPrimitiveBFetchPlus);
    addPrimitive(dictionary, "b@-", ficlPrimitiveBFetchMinus);
    addPrimitive(dictionary, "b!+", ficlPrimitiveBStorePlus);
